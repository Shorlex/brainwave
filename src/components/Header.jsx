    ...
    >
      <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
        <a className="block w-[12rem] xl:mr-8" href="#hero">
          <img src={flutter} width={190} height={40} alt="flutter" />
        </a>
        ...
        <a
          onClick={handleClick}
          href="#signup"
          className="button hidden mr-8 text-n-1/50 lg:block transition-colors hover:text-n-1"
        >
          New Account
        </a>
